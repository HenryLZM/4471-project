...
import torch
from configurations import hed_weight
# import getopt
# import math
# import numpy
# import os
...
# arguments_strIn = './test/sample.png'
...
class HedNet(torch.nn.Module):
	def __init__(self):
		...
		self.load_state_dict({ strKey.replace('module', 'net'): tenWeight for strKey, tenWeight in torch.load(hed_weight).items() })
	# end
